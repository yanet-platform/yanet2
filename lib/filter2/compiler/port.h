...
FILTER_U16_RANGES_DECLARE(
	port, struct filter_query_attr_port, filter_query_attr_port_free
)
...
static const struct filter_compile_u16_handlers filter_compile_attr_port_src = {
	.attr_handlers = filter_compile_attr_port_handlers,
	.get_ranges = filter_rule_get_u16_ranges_port_src,
};

static const struct filter_compile_u16_handlers filter_compile_attr_port_dst = {
	.attr_handlers = filter_compile_attr_port_handlers,
