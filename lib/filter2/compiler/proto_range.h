...
static inline uint32_t
filter_compile_attr_proto_hash(
	const struct filter_compile_attr_handlers *attr_handlers,
	const struct filter_rule *rule
) {
	const struct filter_compile_attr_proto_handlers *proto_handlers =
		container_of(
			attr_handlers,
			struct filter_compile_attr_proto_handlers,
			attr_handlers
	...
	struct filter_proto_ranges ranges;
	proto_handlers->get_proto_ranges(rule, &ranges);
...
static inline int
filter_compile_attr_proto_compare(
	const struct filter_compile_attr_handlers *attr_handlers,
	...
	struct filter_proto_ranges first_ranges;
	struct filter_proto_ranges second_ranges;
	proto_handlers->get_proto_ranges(first, &first_ranges);
	proto_handlers->get_proto_ranges(second, &second_ranges);
...
static const struct filter_compile_attr_handlers
	filter_compile_attr_proto_handlers = {
		...
		.hash = filter_compile_attr_proto_hash,
		.compare = filter_compile_attr_proto_compare,
