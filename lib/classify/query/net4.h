...
struct classify_query_attr_net4_handlers {
	struct classify_query_attr_handlers attr_handlers;
	packet_get_net4_batch_func get_net4;
};

static inline void
classify_query_attr_net4_lookup(
	...
	const struct classify_query_attr_net4_handlers *net4_handlers =
		container_of(
			attr_handlers,
			struct classify_query_attr_net4_handlers,
			attr_handlers
...
static const struct classify_query_attr_handlers filter_query_net4 = {
