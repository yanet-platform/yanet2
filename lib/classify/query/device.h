...
classify_query_attr_device_lookup(
	...
	const struct classify_query_attr_device_handlers *device_handlers =
		container_of(
			attr_handlers,
			struct classify_query_attr_device_handlers,
			attr_handlers
...
static const struct classify_query_attr_handlers filter_query_device_handlers = {
	.lookup = classify_query_attr_device_lookup,
};

static const struct classify_query_attr_device_handlers classify_query_attr_device =
	{
