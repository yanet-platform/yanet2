...
classify_query_attr_vlan_lookup(
	...
	const struct classify_query_attr_vlan_handlers *vlan_handlers =
		container_of(
			attr_handlers,
			struct classify_query_attr_vlan_handlers,
			attr_handlers
...
static const struct classify_query_attr_handlers filter_query_vlan_handlers = {
