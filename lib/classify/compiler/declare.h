 ...
 */
typedef int (*classify_attr_rule_is_any_func)(
 ...
 */
typedef uint32_t (*classify_attr_rule_hash_func)(
	const struct classify_attr_handlers *handlers,
	const struct filter_rule *rule
);
 ...
 */
typedef int (*classify_attr_rule_compare_func)(
	const struct classify_attr_handlers *handlers,
 ...
 */
typedef int (*classify_attr_iter_cb_func)(uint32_t *value, void *data);

/*
 * Iterates over an attribute definition area with a callback for the each
 * region value
 */
typedef int (*classify_attr_iter_func)(
 ...
 */
typedef int (*classify_attr_rule_iter_func)(
	struct classify_attr *attr,
	const struct classify_attr_handlers *handlers,
	const struct filter_rule *rule,
	classify_attr_iter_cb_func iter_cb_func,
 ...
 */
typedef struct classify_query_attr *(*classify_attr_commit_func)(
 ...
 */
typedef void (*classify_attr_free_compile_func)(
	struct memory_context *memory_context, struct classify_attr *attr
);
 ...
 */
typedef void (*classify_attr_free_query_func)(
 ...
 */
struct classify_attr_handlers {
	classify_attr_create_func create;
	classify_attr_size_func size;
	classify_attr_rule_is_any_func rule_is_any;
	classify_attr_rule_hash_func hash;
	classify_attr_rule_compare_func compare;
	classify_attr_rule_iter_func rule_iter;
	classify_attr_iter_func iter;
	classify_attr_commit_func commit;
	classify_attr_free_compile_func free_compile;
	classify_attr_free_query_func free_query;
};
...
classify_attr_build(
	 ...
	 * with zero values.
	 */
	struct classify_attr *attr = attr_handlers->create(
	...
	struct classify_query_attr *query_attr =
