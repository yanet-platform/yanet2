...
struct filter_compile_net6s_attr {
	...
	struct classify_query_attr_net6 *query_attr;
...
classify_attr_net6s_create(
	...
	attr->query_attr = (struct classify_query_attr_net6 *)memory_balloc(
		memory_context, sizeof(struct classify_query_attr_net6)
	);
	if (attr->query_attr == NULL) {
		goto error_free;
	}
	memset(attr->query_attr, 0, sizeof(struct classify_query_attr_net6));
...
static inline uint32_t
classify_attr_net6s_size(const struct classify_attr *attr) {
...
static inline int
classify_attr_net6s_rule_is_any(
...
classify_attr_net6s_commit(
	 ...
	 */
	struct classify_query_attr_net6 *query_attr = net6s_attr->query_attr;
	...
	classify_attr_net6s_free(memory_context, attr);

	return &query_attr->attr;
}

static inline uint32_t
classify_attr_net6_hash(
	const struct classify_attr_handlers *attr_handlers,
	const struct filter_rule *rule
) {
	const struct classify_attr_net6s_handlers *net6s_handlers =
		container_of(
			attr_handlers,
			struct classify_attr_net6s_handlers,
			attr_handlers
...
static const struct classify_attr_handlers filter_compile_get_net6s = {
	.create = classify_attr_net6s_create,
	.size = classify_attr_net6s_size,
	.iter = classify_attr_net6s_iter,
	.rule_iter = classify_attr_net6s_rule_iter,
	.rule_is_any = classify_attr_net6s_rule_is_any,
	.hash = classify_attr_net6_hash,
	.compare = classify_attr_net6_compare,
	.commit = classify_attr_net6s_commit,
	.free_compile = classify_attr_net6s_free,
	.free_query = classify_query_attr_net6_free,
};
