...
// failure everything already built is released, out is zeroed and -1 is
// returned.
int
...
//
// Safe on a partially built or all-zero structure. NULL remap pointers
// are skipped and the whole structure is zeroed afterwards.
void
