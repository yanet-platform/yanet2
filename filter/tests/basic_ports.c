...
test_ports_2() {
	...
	struct filter_action_builder builder1;
	builder_init(&builder1);
	builder_add_src_port_range(&builder1, 1024, 5016);
	builder_add_dst_port_range(&builder1, 500, 50000);
	struct filter_action action1 = build_action(&builder1, 1);
	...
	builder_add_src_port_range(&builder3, 100, 2014);
	builder_add_dst_port_range(&builder3, 5000, 15000);
