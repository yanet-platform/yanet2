...
// and that family's table offset stays NULL — the module then counts and
// drops that family's sync frames without inserting. A name that
// resolves to no object in the agent's current configuration fails the
// construction.
//
