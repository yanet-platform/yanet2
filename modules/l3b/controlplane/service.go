...
// GetService inspects a named virtual service: its scheduler masks and the
// live real servers with addresses, weights and states.
func (m *L3BService) GetService(
	ctx context.Context,
