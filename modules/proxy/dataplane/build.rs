...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_function("packet_list_pop")
        .allowlist_function("packet_list_add")
        .allowlist_function("packet_list_init")
        .allowlist_function("packet_front_output")
        .allowlist_function("packet_front_drop")
        .allowlist_function("packet_front_init")
        .allowlist_function("packet_to_mbuf")
    ...
    cc::Build::new()
        ...
        .include(format!("{}/build/subprojects/dpdk", project_root.display()))
