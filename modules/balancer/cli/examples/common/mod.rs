        ...
        module_config: Some(balancerpb::ModuleConfig {
            virtual_services: vec![
                balancerpb::VirtualService {
                    ...
                    allowed_srcs: vec![
                        balancerpb::Subnet { addr: vec![10, 0, 0, 0], size: 8 },
                        balancerpb::Subnet { addr: vec![172, 16, 0, 0], size: 12 },
                    ],
                    reals: vec![
                        balancerpb::Real {
                            weight: 100,
                ...
                balancerpb::VirtualService {
                    ...
                    allowed_srcs: vec![balancerpb::Subnet { addr: vec![0, 0, 0, 0], size: 0 }],
                    reals: vec![
                        balancerpb::Real {
                            weight: 100,
            ...
            wlc: Some(balancerpb::WlcConfig {
                ...
                update_period: Some(prost_types::Duration { seconds: 5, nanos: 0 }),
            }),
        }),
        module_state_config: Some(balancerpb::ModuleStateConfig {
            session_table_capacity: 1_000_000,
            session_table_scan_period: Some(prost_types::Duration { seconds: 1, nanos: 0 }),
...
pub fn create_list_configs_example() -> balancerpb::ListConfigsResponse {
    ...
    let config2 = balancerpb::ShowConfigResponse {
        ...
        module_config: Some(balancerpb::ModuleConfig {
            virtual_services: vec![balancerpb::VirtualService {
            ...
            wlc: Some(balancerpb::WlcConfig {
                wlc_power: 5,
                max_real_weight: 500,
                update_period: Some(prost_types::Duration { seconds: 10, nanos: 0 }),
            }),
        }),
        module_state_config: Some(balancerpb::ModuleStateConfig {
            session_table_capacity: 500_000,
            session_table_scan_period: Some(prost_types::Duration { seconds: 2, nanos: 0 }),
    ...
    balancerpb::ListConfigsResponse { configs: vec![config1, config2] }
}
    ...
    balancerpb::StateInfoResponse {
        ...
        info: Some(balancerpb::BalancerInfo {
            active_sessions: Some(balancerpb::AsyncInfo {
                value: 15234,
                updated_at: Some(prost_types::Timestamp { seconds: 1705315845, nanos: 0 }),
            }),
            ...
            vs_info: vec![
                balancerpb::VsInfo {
                    ...
                    active_sessions: Some(balancerpb::AsyncInfo {
                        value: 10234,
                        updated_at: Some(prost_types::Timestamp { seconds: 1705315844, nanos: 0 }),
                    }),
            ...
            real_info: vec![
                balancerpb::RealInfo {
                    ...
                    active_sessions: Some(balancerpb::AsyncInfo {
                        value: 6000,
                        updated_at: Some(prost_types::Timestamp { seconds: 1705315843, nanos: 0 }),
                    }),
                    last_packet_timestamp: Some(prost_types::Timestamp { seconds: 1705315844, nanos: 0 }),
