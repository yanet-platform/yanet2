...
struct balancer_vs_stats {
	...
	_Atomic uint64_t broadcasted_icmp_packets;

	// Total created sessions.
	_Atomic uint64_t created_sessions;
...
struct balancer_real_stats {
	...
	_Atomic uint64_t packets_real_disabled;

	// Number of packets which arrived when real is not present
	// in the config.
	_Atomic uint64_t packets_real_not_present;
