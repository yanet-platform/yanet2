...
func TestValidateNet(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			&filterpb.IPNet{
				Addr: make([]byte, 16),
				Mask: []byte{0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
			},
			true, false,
		},
		{
		...
		},
		{
			...
			&filterpb.IPNet{
				Addr: make([]byte, 16),
				Mask: []byte{0xFF, 0xFE, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
			},
			true, true,
		},
	}
