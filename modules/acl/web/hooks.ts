 ...
 *
 * This is the expensive part: it formats all the range arrays into
 * human-readable strings. Call this inside a per-row useMemo or on drawer
 * open so only visible rows pay the cost.
 *
