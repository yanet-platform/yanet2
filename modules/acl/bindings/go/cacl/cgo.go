...
// fwstate_map_v6 objects whose fwtables back state lookups. An empty
// name declares no link, and CHECK_STATE then falls back to the fwstate
// module config linked via SetFwStateConfig. Pass nil emitConfig for a
// ruleset that emits no sync packets.
