...
static inline int
lpm_wide_8b_insert(
	struct lpm_wide *lpm8,
	const uint8_t *from,
	const uint8_t *to,
	uint32_t value
) {
	return lpm_wide_insert(lpm8, 8, from, to, value);
}

static inline uint32_t
lpm_wide_8b_lookup(const struct lpm_wide *lpm8, const uint8_t *key) {
	return lpm_wide_lookup(lpm8, 8, key);
}

static inline int
lpm_wide_8b_collect_values(
	const struct lpm_wide *lpm8,
	const uint8_t *from,
	const uint8_t *to,
	lpm_wide_collect_values_func collect_func,
	void *collect_func_data
) {
	return lpm_wide_collect_values(
...
lpm_wide_8b_walk(
	...
	return lpm_wide_walk(lpm8, 8, from, to, walk_func, walk_func_data);
}

static inline void
lpm_wide_8b_remap(struct lpm_wide *lpm8, struct value_table *table) {
	return lpm_wide_remap(lpm8, 8, table);
}

static inline void
lpm_wide_8b_compact(struct lpm_wide *lpm8) {
	return lpm_wide_compact(lpm8, 8);
}

static inline int
lpm_wide_4b_insert(
	struct lpm_wide *lpm4,
	const uint8_t *from,
	const uint8_t *to,
	uint32_t value
) {
	return lpm_wide_insert(lpm4, 4, from, to, value);
}

static inline uint32_t
lpm_wide_4b_lookup(const struct lpm_wide *lpm4, const uint8_t *key) {
	return lpm_wide_lookup(lpm4, 4, key);
}

static inline int
lpm_wide_4b_collect_values(
	const struct lpm_wide *lpm4,
	const uint8_t *from,
	const uint8_t *to,
	lpm_wide_collect_values_func collect_func,
	void *collect_func_data
...
lpm_wide_4b_walk(
	...
	return lpm_wide_walk(lpm4, 4, from, to, walk_func, walk_func_data);
}

static inline void
lpm_wide_4b_remap(struct lpm_wide *lpm4, struct value_table *table) {
	return lpm_wide_remap(lpm4, 4, table);
}

static inline void
lpm_wide_4b_compact(struct lpm_wide *lpm4) {
	return lpm_wide_compact(lpm4, 4);
}
