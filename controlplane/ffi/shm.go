...
// If Agent with such name already attached, it will be cleaned.
...
// AgentsReattach attaches agents to shared memory on the specified list of instances.
func (m *SharedMemory) AgentsReattach(name string, instanceIndices []uint32, size datasize.ByteSize) ([]*Agent, error) {
