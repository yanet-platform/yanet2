...
// TestTest_002_decap_default verifies that packets tunneled to the decap
// prefix are decapsulated and the inner packet is forwarded onward.
//
// Migrated from yanet1 autotest 002_decap_default.
...
func create002_decap_defaultSendPacket1Helper(t *testing.T, params create002_decap_defaultSendPacket1Params) gopacket.Packet {
	pkt, err := framework.NewPacket(nil,
		...
		framework.IPv6(
			framework.IPv6Src("::"),
			framework.IPv6Dst("1:2:3:4::abcd"),
