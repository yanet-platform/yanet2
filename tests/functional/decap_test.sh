...
/mnt/target/release/yanet-cli-pipeline update --name=decap --modules forward:forward0 --modules decap:decap0 --modules route:route0

# Assign pipelines to devices (use device names, not IDs)
#/mnt/target/release/yanet-cli-pipeline assign --device=00:03.0 --pipelines decap:1
/mnt/target/release/yanet-cli-pipeline assign --device=01:00.0 --pipelines decap:1
/mnt/target/release/yanet-cli-pipeline assign --device=virtio_user_kni0 --pipelines bootstrap:1
