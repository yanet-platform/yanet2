---
name: yanet-lab
description: Operate and troubleshoot the reusable local YANET2 QEMU operator lab. Use when asked to boot or reset a lab VM, inspect YANET in a guest, validate or author lab manifests, run forward-route/decap/NAT64 scenarios, execute packet probes, or collect a lab report.
---
